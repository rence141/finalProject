        ...
        if ($inputPassword === $user['password']) {
            ...
            if ($actualUserType === 'Admin') {
                ...
                if ($selectedUserType === 'Admin') {
                    header("Location: /Project_BroomBroom/redirect/Ecommerce_admin.html");
                } elseif ($selectedUserType === 'User') {
                    header("Location: /Project_BroomBroom/redirect/ecommerce_user.html");
                } else {
                    echo "<script>alert('Invalid UserType selection.'); window.history.back();</script>";
                }
                exit();
            } 
